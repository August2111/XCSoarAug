...
#   PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/${TARGET_NAME}_CMakeLists.txt.in" <SOURCE_DIR>/CMakeLists.txt
   PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different "${PROJECTGROUP_SOURCE_DIR}/3rd_party/${TARGET_NAME}_CMakeLists.txt.in" <SOURCE_DIR>/CMakeLists.txt
